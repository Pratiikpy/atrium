    ...
    <AppShell
      ...
      <section className="mt-8 rounded-md border border-divider bg-parchment-soft/40 p-6">
        ...
        <ul className="mt-4 space-y-2 text-sm text-ink-soft">
          ...
          <li>• Withdrawal SLA: settle within 1 block (≈250 ms on Arbitrum Sepolia) when no breaker is active; on-chain attestation about every 45 minutes via Lantern.</li>
