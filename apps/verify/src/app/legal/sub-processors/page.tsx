...
const PROCESSORS = [
  ...
  { name: 'SimpleAnalytics', url: 'https://simpleanalytics.com', purpose: 'Privacy-friendly page analytics', data: 'Aggregated page views (no individual records, no cookies)', location: 'Netherlands, EU', dpa: null },
  { name: 'Sumsub', url: 'https://sumsub.com', purpose: 'KYC identity verification (opt-in only)', data: 'Government ID, selfie, biometric data', location: 'United Kingdom / EU', dpa: null },
