...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    body: "Atrium never holds your funds, and it proves it. Lantern publishes a signed Merkle root of all balances about every 10 minutes. Click verify and the server checks your wallet's inclusion proof against the on-chain root, a real result, never a fake 'verified'.",
    spec: 'Latest signed root · attested block · leaf count · published about every 10 minutes',
    href: '/app',
