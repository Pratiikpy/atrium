  ...
  return (
    <section className="closing border-t border-divider bg-parchment-light">
      <div className="mx-auto max-w-3xl px-6 py-24 text-center md:py-32">
        ...
        <p className="mx-auto mt-3 inline-flex items-center gap-1.5 rounded-full border border-testnet/30 bg-testnet/5 px-3 py-1 text-[10px] uppercase tracking-wider text-testnet">
