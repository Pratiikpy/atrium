...
export function KaniBadge() {
  ...
  if (!status) {
    return (
      <span
        className="fixed right-4 top-4 z-50 inline-flex items-center gap-2 rounded-md border border-divider bg-parchment px-3 py-1.5 text-xs font-medium text-ink-soft shadow-sm"
        aria-live="polite"
      >
