...
describe('Vigil handlers', () => {
  ...
  test('handleLiquidationExecuted creates LiquidationEvent and increments Counter', () => {
    ...
    createMockedFunction(vigilAddr, 'jobs', 'jobs(uint256):(uint256,address,uint256,uint256,uint64,uint8,bool,address)')
      ...
      .returns([
        ...
        ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(123456)),
